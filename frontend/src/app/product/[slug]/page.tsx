    ...
    <>
      ...
      <div className="mx-auto grid max-w-page gap-10 px-5 py-10 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:py-16">
        ...
        <div>
          ...
          <h2 className="mt-3 font-serif text-3xl leading-tight text-ink sm:text-4xl">{product.name}</h2>
          ...
          <div className="mt-6 flex items-baseline gap-3">
            ...
            <p className="text-sm text-ink/40 line-through">{formatKsh(product.compareAtPrice)}</p>
            }
          </div>
            ...
            <Accordion
              ...
              },
              {
                ...
                <p>
                      ...
                      <Link to="/wig-care" className="text-chestnut underline underline-offset-4">
                        Wig Care Guide
                      </Link>{' '}
              ...
              },
              {
                ...
                content:
                <p>
                      Delivery options, fees and timelines are configured by Dallian Luxe Hair and shown at
                      checkout. See{' '}
                      <Link to="/delivery" className="text-chestnut underline underline-offset-4">
              ...
              },
              {
                ...
                <p>
                      ...
                      <Link to="/returns" className="text-chestnut underline underline-offset-4">
                        Returns Policy
                      </Link>
                      .
                    </p>
