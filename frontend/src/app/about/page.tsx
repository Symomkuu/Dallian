        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-ink/65">
              Our tagline — {brand.tagline} — is how we work. We would rather help you choose one piece you
              love and wear often than sell you something that sits in a box.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative mx-auto max-w-page px-5 py-20 sm:px-8 lg:py-28">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-cream/65">
              Come in to compare textures and lengths in person, or talk to us before you order online — we
              are happy to advise.
            </p>
